...
extern  NET_TASK_CFG  NetRxTaskCfg;
extern  NET_TASK_CFG  NetTxDeallocTaskCfg;
extern  NET_TASK_CFG  NetTmrTaskCfg;
...
#define  NET_IF_CFG_MAX_NBR_IF                  2u              /* Configure maximum number of network interfaces.      */
...
#define  NET_IPv4_CFG_IF_MAX_NBR_ADDR           2u              /* Configure maximum number of addresses per interface. */
...
#define  NET_SOCK_CFG_CONN_ACCEPT_Q_SIZE_MAX    2u              /* maximum size. (See Note # 1)                         */
                                                                ...
                                                                /* (see Note #2):                                       */
#define  NET_SOCK_CFG_RX_Q_SIZE_OCTET           (4 * 1460u)     /* Configure socket receive  queue buffer size.         */
#define  NET_SOCK_CFG_TX_Q_SIZE_OCTET           (4 * 1460u)     /* Configure socket transmit queue buffer size.         */
