...
*/
                                                                ...
                                                                /* Declare each specific dev's config. (see Note #1) :  */
#ifdef  NET_IF_ETHER_MODULE_EN

extern  const  NET_DEV_CFG_ETHER  NetDev_Cfg_K64F120M;          /*   Example Ethernet     configuration for dev A, #1.  */
extern  const  NET_PHY_CFG_ETHER  NetPhy_Cfg_K64F120M;          /*   Example Ethernet Phy configuration for dev A, #1.  */
