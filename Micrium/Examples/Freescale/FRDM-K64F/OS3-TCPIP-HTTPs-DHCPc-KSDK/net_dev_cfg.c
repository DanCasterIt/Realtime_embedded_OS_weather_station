...
const  NET_DEV_CFG_ETHER  NetDev_Cfg_K64F120M = {
    ...
    NET_DEV_CFG_FLAG_NONE,          /* Desired option flags, if any (see Note #6).                                      */
             ...
             2u,                    /* Desired number of device's receive  descriptors (see Note #7).                   */
             2u,                    /* Desired number of device's transmit descriptors.                                 */
...
const  NET_PHY_CFG_ETHER  NetPhy_Cfg_K64F120M = {
