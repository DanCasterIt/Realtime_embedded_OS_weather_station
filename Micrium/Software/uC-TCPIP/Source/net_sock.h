...
#define  NET_SOCK_PORT_NBR_RANDOM_MAX                   (NET_SOCK_DFLT_PORT_NBR_RANDOM_BASE + NET_SOCK_PORT_NBR_RANDOM_NBR - 1)
...
#define  NET_SOCK_ADDR_IPv4_NBR_OCTETS_UNUSED        8
    ...
    #define  NET_SOCK_ADDR_IPv6_SIZE            (sizeof(NET_SOCK_ADDR_IPv6))
                                                                        ...
                                                                        /* -------------- NET SOCK ADDR --------------- */
#if   (defined(NET_IPv6_MODULE_EN))
    #define  NET_SOCK_BSD_ADDR_LEN_MAX                  NET_SOCK_ADDR_IPv6_SIZE

#elif (defined(NET_IPv4_MODULE_EN))

    #define  NET_SOCK_BSD_ADDR_LEN_MAX                  NET_SOCK_ADDR_IPv4_SIZE
